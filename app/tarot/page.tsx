          ...
          {allTarotCards.map((card) => {
            ...
            return (
              <Link
                ...
                className="group relative aspect-[300/527] overflow-hidden rounded-lg outline outline-[0.2px] outline-black bg-muted shadow-[0_2px_6px_rgba(0,0,0,0.12)] transition-transform hover:-translate-y-1"
              >
                <TarotCardImage
                  src={card.imageUrl}
