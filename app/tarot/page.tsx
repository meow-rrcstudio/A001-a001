          ...
          {allTarotCards.map((card) => {
            ...
            return (
              <Link
                ...
                // 3px #F3E6E0 · 라운드 6px · 그림자 0 2px 6px (Figma 시안)
                className="group relative aspect-[300/527] overflow-hidden rounded-lg outline outline-[3px] outline-[#F3E6E0] bg-muted shadow-[0_2px_6px_rgba(0,0,0,0.12)] transition-transform hover:-translate-y-1"
              >
                <TarotCardImage
                  src={card.imageUrl}
