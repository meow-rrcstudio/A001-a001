...
> = {
   ...
   * 고객 문의 이메일.
   *
   * 도메인 메일입니다 — Namecheap 이메일 전달로 받아서 개인 메일함으로
   * 넘어옵니다. 별칭으로 hello@ 도 같은 곳으로 옵니다(공개는 이 주소만).
   *
   * ⚠️ 개인 메일 주소로 되돌리지 마세요. 환불·분쟁 문의가 오가는 자리라
   *    도메인 주소여야 신뢰가 생기고, 나중에 사람이 늘어도 주소를
   *    옮길 필요가 없습니다.
   */
  email: "help@soulseoul.xyz",
