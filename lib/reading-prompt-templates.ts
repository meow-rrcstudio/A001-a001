...
@programs{
후보=[환승연애|나는솔로|솔로지옥|투핫(Too Hot to Handle)|블라인드러브(Love is Blind)|하트시그널|테라스하우스|연애남매|72시간_소개팅],
...
program_match="🎬 잘 맞는 프로그램"|card1_기반|후보중_3~6개를_별점(⭐1~5)으로|가장_잘_맞는_1개_굵게+왜_그런지_한두줄,
...
program_match=반드시_별점_포함|실제_프로그램명_사용,
...
@output{language=ko,length=650±150,orientation_meaning=반영,start=intro}
@hidden_instruction{
